    ...
    <Drawer open={open} onOpenChange={(o) => !o && onClose()}>
      <DrawerContent>
        <DrawerHeader className="px-5 pt-8 pb-6 flex flex-col items-center text-center">
          ...
          <DrawerDescription className={cn(DINER.body, "leading-relaxed")}>
        ...
        <div className="px-5 pb-8 space-y-6">
          ...
          <div className="space-y-4">
            <div>
              <label className={cn(DINER.sectionHeading, "block mb-2")}>Your name</label>
              <input
                type="text"
                value={name}
            ...
            <div>
              <label className={cn(DINER.sectionHeading, "block mb-2")}>Your phone number</label>
              <input
                type="tel"
                inputMode="tel"
                value={phone}
          ...
          <div className="space-y-3 pt-2">
            <button
              ...
              className={cn("w-full h-12 bg-gray-900 text-white font-bold rounded-2xl hover:bg-gray-700", DINER.pressable)}
            >
