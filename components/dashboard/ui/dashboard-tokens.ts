...
export const t = {
  ...
  // ── Labels & Meta ─────────────────────────────────────────────────────────
  label: "text-xs    font-medium text-gray-500", // field labels, above inputs
  ...
  stat3xl:
    "text-3xl font-bold text-gray-900 tracking-tight [font-variant-numeric:tabular-nums]",
  number:
    "text-sm   font-bold  text-gray-900 [font-variant-numeric:tabular-nums]",
  numberMd:
    "text-base font-bold text-gray-900 [font-variant-numeric:tabular-nums]",
  price:
    "text-sm   font-bold  text-gray-900 [font-variant-numeric:tabular-nums]",
...
export const ds = {
  ...
  btn: {
    ...
    icon: "inline-flex items-center justify-center w-9 h-9 rounded-xl bg-white border border-gray-200 text-gray-500 hover:bg-gray-50 hover:text-gray-900 transition-colors",

    /** Tab / filter pill — inactive */
    tab: "inline-flex items-center justify-center h-8 px-3 text-xs font-medium text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition-colors",
    ...
    link: "inline-flex items-center gap-1 text-xs font-semibold text-orange-500 hover:text-orange-600 transition-colors",
  },
  ...
  card: {
    ...
    // </div>
    header:
      "flex items-center justify-between px-5 pt-5 pb-4 border-b border-gray-50",
    body: "p-5",
  ...
  metric: {
    ...
    value:
      "text-2xl font-bold text-gray-900 tracking-tight [font-variant-numeric:tabular-nums]",
    ...
    iconAccent:
      "w-9 h-9 rounded-xl bg-orange-50 text-orange-500 flex items-center justify-center flex-none",

    /** Icon container — neutral */
    iconMuted:
      "w-9 h-9 rounded-xl bg-gray-50 text-gray-400 flex items-center justify-center flex-none",
  },
  ...
  // ── INPUTS ───────────────────────────────────────────────────────────────
  input: {
    base: "w-full h-10 px-3 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900/20 focus:border-gray-900 transition-all",
    ...
    select:
      "w-full h-10 px-3 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900/20 focus:border-gray-900 transition-all",
  ...
  avatar: {
    ...
    brand:
      "w-8 h-8 rounded-lg bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center flex-none text-white text-xs font-bold",
    brandLg:
      "w-10 h-10 rounded-xl bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center flex-none text-white text-sm font-bold",
  },
  ...
  iconBox: {
    ...
    accent:
      "w-9  h-9  rounded-xl  bg-orange-50  text-orange-500 flex items-center justify-center",
    muted:
      "w-9  h-9  rounded-xl  bg-gray-50    text-gray-400   flex items-center justify-center",
    success:
      "w-9  h-9  rounded-xl  bg-green-50   text-green-600  flex items-center justify-center",
    danger:
      "w-9  h-9  rounded-xl  bg-red-50     text-red-500    flex items-center justify-center",
  },
  ...
  form: {
    ...
    actions: "flex justify-end gap-2 border-t border-gray-100 pt-4",
    stickyActions:
      "sticky bottom-0 -mx-5 border-t border-gray-100 bg-white px-5 py-4",
    sectionTitle:
