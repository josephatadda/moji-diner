  ...
  return (
    ...
    >
      ...
      <div className="bg-white border-b border-gray-100 px-3 py-2.5 flex items-center justify-between">
        <div>
          <p className="font-bold text-gray-900 text-xs leading-tight truncate max-w-[140px]">
            {restaurantName}
          </p>
            ...
            {category.items.map((item) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] font-semibold text-gray-900 leading-tight line-clamp-1">
                    {item.name}
                  </p>
                  <p className="text-[8px] text-orange-600 font-bold mt-0.5">
