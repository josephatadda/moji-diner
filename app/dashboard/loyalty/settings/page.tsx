...
export default function LoyaltySettingsPage() {
  const loyaltyFeatureEnabled = useDashboardSettingsStore(
  ...
  if (!loyaltyFeatureEnabled) {
    return (
      <DashboardSetupPrompt
        ...
        description="Enable loyalty before adjusting earning rates, tiers, and customer rewards."
        ...
        <div className="flex items-center justify-between bg-white border border-gray-100 rounded-2xl p-5">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">
              Enable or disable rewards for customers
            </p>
          </div>
          <button
            type="button"
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-5 space-y-4">
              ...
              <div className="flex items-start gap-2.5 p-3 bg-blue-50 rounded-xl border border-blue-100">
                ...
                <p className="text-xs text-blue-700">
                  Changing the rate only applies to future orders — existing
