...
export default function CustomerProfilePage() {
  ...
  const customerOrders = MOCK_ORDERS.filter(
    (o) => o.dinerPhone === phone || o.tableNumber === 1,
  );
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-3 lg:grid-cols-1 gap-3">
            {[
              {
                label: "Points",
                value: `${profile.totalPoints.toLocaleString()} pts`,
              },
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-4 space-y-2">
            ...
            <button
              type="button"
              className="w-full flex items-center justify-center gap-2 py-2.5 bg-green-600 text-white text-sm font-bold rounded-xl hover:bg-green-700 transition-colors"
            >
